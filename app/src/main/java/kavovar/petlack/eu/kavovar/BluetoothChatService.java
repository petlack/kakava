...
//        }
    ...
    public void write(byte[] out) {
        ...
        Log.d(TAG, "write before " + Arrays.toString(out));
        // Perform the write unsynchronized
        r.write(out);
        Log.d(TAG, "write after " + Arrays.toString(out));
    }
    /**
    ...
    private void connectionFailed() {
        ...
        msg.setData(bundle);
        mHandler.sendMessage(msg);
        mHandler.obtainMessage(BluetoothChat.MESSAGE_STATE_CHANGE, STATE_FAILED, -1).sendToTarget();
    }
    /**
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                mmSocket.connect();
                Log.d(TAG, "mmSocket.connect() finished");
            } catch (IOException e) {
